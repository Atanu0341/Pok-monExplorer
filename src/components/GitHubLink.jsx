...
const GitHubLink = () => {
  return (
    <div className="fixed top-2 right-2 z-50"> {/* Positioning */}
      <a
        href="https://github.com/Atanu0341/Pok-monExplorer" // Replace with your GitHub URL
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center text-gray-800 hover:text-gray-600 transition duration-200" // Removed background and span
      >
        <svg
